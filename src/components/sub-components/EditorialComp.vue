	...
	<div class="container">
		<div class="row">
			<div>
				...
				<div>
					<p>
						Every week we publish content about what is best in the
						business world.
					</p>
					<button><a href="#">SEE ALL</a></button>
				</div>
			</div>
			<div class="editorials" v-dragscroll="true">
				<div
					:key="i"
...
<script>
// Libreria che permette il grab and scroll
